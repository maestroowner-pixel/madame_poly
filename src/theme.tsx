...
export const lightTheme = {
  ...
  highlight: '#0A6E9E',
  /** Цвет значков на кнопках шапки. В светлой теме свечения нет, поэтому
      совпадает с акцентом. */
  neon: '#17769F',
...
export const darkTheme: Theme = {
  /** Густой оксфордский синий: прежний индиго отдавал в фиолет и спорил с
      сиреневым акцентом — на тёмном фоне два лиловых рядом мутят друг друга. */
  bg: '#041B35',
  surface: '#0E2B4C',
  surfaceAlt: '#173C63',
  border: '#21507C',
  ...
  /** Тёмный пурпур шёлка в тени, а не синяя сирень. Ниже опускать нельзя:
      пузырь начинает сливаться с фоном. */
  accent: '#5E3782',
  accentText: '#FFFFFF',
  /** В тёмной теме кнопка беседы берёт цвет пузыря собеседника — с ним же
      светлым кантом, чтобы не сливаться с лентой сообщений. */
  ctaBg: '#5E3782',
  ctaBorder: '#B98FE0',
  ctaText: '#ECF9FB',
  highlight: '#63D0FA',
  /** Светлая сирень для значков: тёмный акцент на тёмно-синей кнопке пропадал.
      Она же светится вокруг них. */
  neon: '#C79BFF',
